        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <Link href="/about-us.tsx" className="text-gray-300 hover:text-white font-medium transition-colors">
                About Us
              </Link>
              <Link href="/testimonials.tsx" className="text-gray-300 hover:text-white font-medium transition-colors">
                Testimonials
              </Link>
              <Link href="/regions.tsx" className="text-gray-300 hover:text-white font-medium transition-colors">
                Regions
              </Link>
              <Button
          ...
          {isMenuOpen && (
            <nav className="md:hidden mt-4 pb-4 border-t border-gray-800 pt-4">
              <div className="flex flex-col space-y-4">
                <Link href="/about-us.tsx" className="text-gray-300 hover:text-white transition-colors">
                  About Us
                </Link>
                <Link href="/testimonials.tsx" className="text-gray-300 hover:text-white transition-colors">
                  Testimonials
                </Link>
                <Link href="/regions.tsx" className="text-gray-300 hover:text-white transition-colors">
                  Regions
                </Link>
